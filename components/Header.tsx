      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-10 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link to="/dashboard" className="text-sm font-medium hover:text-primary transition-colors">Panou de control</Link>
            <Link to="/login" className="text-sm font-medium hover:text-primary transition-colors">Autentificare</Link>
          </div>
          <Link to="/search" className="bg-primary text-white text-sm font-bold px-5 h-10 rounded-lg hover:bg-primary/90 transition-colors whitespace-nowrap flex items-center">
