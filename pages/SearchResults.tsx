...
const SearchResults: React.FC = () => {
  return (
    <div className="bg-background-light text-[#111418] font-display antialiased overflow-x-hidden flex flex-col min-h-screen">
      <div className="sticky top-0 z-50 bg-white border-b border-[#f0f2f4]">
         {/* Using a modified header for search results to match the mockup exactly */}
         <div className="max-w-[1440px] mx-auto px-4 md:px-8 h-16 flex items-center justify-between gap-4">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-[#f0f2f4] rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors whitespace-nowrap">
            ...
            <div className="flex w-full items-center rounded-lg bg-[#f0f2f4] h-10 px-3 gap-2 focus-within:ring-2 focus-within:ring-primary/50 transition-all">
                ...
                <input className="w-full bg-transparent border-none p-0 text-sm text-[#111418] placeholder:text-[#617289] focus:ring-0" placeholder="Caută ciment, gresie, unelte..."/>
            </div>
            </div>
            <div className="flex items-center gap-4 md:gap-6">
            <div className="hidden md:flex items-center gap-6">
                <Link to="/list-item" className="text-sm font-medium hover:text-primary transition-colors">Listează un produs</Link>
                <Link to="#" className="text-sm font-medium hover:text-primary transition-colors">Autentificare</Link>
            </div>
            <button className="relative">
                <span className="material-symbols-outlined text-[#111418]">shopping_cart</span>
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 md:px-8 py-8 flex gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link to="/product" className="bg-white rounded-xl border border-[#e5e7eb] overflow-hidden hover:shadow-lg transition-shadow group cursor-pointer flex flex-col h-full">
