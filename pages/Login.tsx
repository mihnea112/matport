      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="#" className="text-sm font-medium text-primary hover:underline">Ai uitat parola?</Link>
              </div>
              <input 
                className="w-full h-12 px-4 rounded-lg border border-[#e2e8f0] text-[#111418] placeholder:text-[#617289] focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" 
                id="password" 
          ...
          <p className="mt-8 text-center text-[#617289]">
            Nu ai un cont? <Link to="/register" className="font-bold text-primary hover:underline">Înregistrează-te</Link>
          </p>
        </div>
      </div>
    </div>
