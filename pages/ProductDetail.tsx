      ...
      <main className="flex-grow">
        <div className="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-10 py-4">
          <nav className="flex text-sm text-[#617289]">
            ...
            <Link to="/search" className="hover:text-primary transition-colors">Materiale Acoperiș</Link>
            <span className="mx-2">/</span>
            <Link to="/search" className="hover:text-primary transition-colors">Țiglă Ceramică</Link>
            <span className="mx-2">/</span>
